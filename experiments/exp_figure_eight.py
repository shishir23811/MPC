...
def run_experiment():
    ...
    print(f"Figure-8 MPC tracking: mean error = {mean_error:.4f} m, max error = {max_error:.4f} m, RMSE = {rmse_error:.4f} m")
    ...
    return mean_error, max_error, rmse_error, output_path, error_plot
